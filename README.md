...
1. Склонировать репозиторий проекта по ссылке https://github.com/EkaterinaYurchyk2022/employees-react-express на свой компьютер.
```
git clone https://github.com/EkaterinaYurchyk2022/employees-react-express.git
```
...
3. Установить зависимости для серверной части проекта. Ввести следующую команду в терминале:
```
npm install
```
...
9. Запустить проект. Ввести следующую команду в терминале:
```
npm run dev
```
